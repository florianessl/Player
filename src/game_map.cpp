...
static bool WouldCollide(const Game_Character& self, const T& other, bool self_conflict) {
	...
	if (self.GetLayer() == other.GetLayer()) {
		...
		if constexpr (impl == Game_Map::eImpl_AssertWayForeground || impl == Game_Map::eImpl_AssertWayBackground) {
			...
			auto check_rng_move = [&](Game_Character const& ch, std::unordered_set<int>* ignore_list) {
			...
			ignore_list.emplace(GetEventId(self));
				...
				switch (static_cast<Code>(move_command.command_id)) {
					...
					case Code::move_towards_hero:
						if constexpr (impl == Game_Map::eImpl_AssertWayForeground) {
							...
							move_success = other.CheckMove(other.GetDirectionToHero());
						}
						break;
					case Code::move_away_from_hero:
						if constexpr (impl == Game_Map::eImpl_AssertWayForeground) {
							...
							move_success = other.CheckMove(other.GetDirectionAwayHero());
						}
						break;
				}
				if (move_success) {
		...
		)
{
	return CheckOrMakeWayEx<true, eImpl_CheckWay>(
		self, from_x, from_y, to_x, to_y, nullptr
	);
}
...
template bool Game_Map::CheckOrMakeWayEx<true, Game_Map::eImpl_CheckWay>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<true, Game_Map::eImpl_MakeWay>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<true, Game_Map::eImpl_AssertWayForeground>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<true, Game_Map::eImpl_AssertWayBackground>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<false, Game_Map::eImpl_CheckWay>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<false, Game_Map::eImpl_MakeWay>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<false, Game_Map::eImpl_AssertWayForeground>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
template bool Game_Map::CheckOrMakeWayEx<false, Game_Map::eImpl_AssertWayBackground>(const Game_Character& self, int, int, int, int, std::unordered_set<int>*);
		...
		)
{
	return CheckOrMakeWayEx<true, eImpl_MakeWay>(
		self, from_x, from_y, to_x, to_y, NULL);
}
...
static void OnEncounterEnd(BattleResult result) {
	...
	if (ce) {
		...
		interp.Push(ce, Debug::ePush_DeathHandler);
	}
