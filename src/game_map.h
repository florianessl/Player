...
namespace Game_Map {
	...
	enum CheckOrMakeWayImpl {
		eImpl_CheckWay,
		/* 'CheckOrMakeWayEx' cause side effects. */
		eImpl_MakeWay,
		/* 'CheckOrMakeWayEx' will generate warnings
		    for blocked movement. */
		eImpl_AssertWayForeground,
		eImpl_AssertWayBackground
	};
	 ...
	 */
	template<bool check_events_and_vehicles, CheckOrMakeWayImpl impl>
